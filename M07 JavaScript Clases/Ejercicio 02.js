...
class Persona {
   ...
   constructor(nombre,apellido,edad,domicilio){
      ...
      detalle(){
         return{          //DEVUELVE UN OBJETO CON LAS PROPIEDADES DE PERSONSA Y SUS VALORES (KEY,VALUE)
            nombre: this.nombre,
...
function agregarMetodo() {
   ...
   Persona.prototype.datos = function(){
      return this.nombre+ ", " + this.edad + " años"  // SIEMPRE VERIFICAR LA COMA EN QUE POSICION SE ENCUENTRA, SI NO, NO VA A CORRER
   }
